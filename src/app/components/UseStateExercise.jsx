      ...
      <div className="exercise-card">
        <div className="card-header">
          ...
          <p className="card-description">
            Få input-feltet til at opdatere
            overskriften i real-tid
          </p>
        </div>
        ...
        <div className="card-content">
          ...
          <div className="help-box">
            ...
            <ul className="help-list">
              ...
              <li>
                2. Opret en state variabel til
                teksten
              </li>
              <li>
                3. Tilføj value og onChange til
                input-feltet
              </li>
              <li>
                4. Se overskriften opdatere i
                real-time!
              </li>
            </ul>
          </div>
