...
export default function LikeCounterExercise() {
  ...
  // handleLike opdaterer likes og isLiked
  const handleLike = () => {
    setLikes(likes + 1); // Øger likes med 1
    setIsLiked(true); // Sætter isLiked til true
  };
  return (
      ...
      <div className="post-card">
        ...
        <div className="post-header">
          ...
          <p className="exercise-description">
            Få opslagets like-knap til at tælle
            likes
          </p>
        </div>
        ...
        <div className="post-content">
          ...
          <p className="post-text">
            Dette er et fantastisk opslag! Klik på
            like-knappen nedenfor for at vise din
            støtte. Knappen skal skifte farve og
            tælleren skal opdateres.
          </p>
        </div>
        ...
        <div className="help-section">
          ...
          <ul className="help-list">
            ...
            <li>
              Opret likes state (starter på 0)
            </li>
            <li>
              Opret ex. isLiked state (starter på
              false)
            </li>
            <li>
              Implementer handleLike funktionen
            </li>
            <li>
              Toggle isLiked og opdater likes
              tælleren
            </li>
            <li>
              Se like-knappen skifte farve og
              tælleren opdatere!
            </li>
          </ul>
        </div>
